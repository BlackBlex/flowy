document.addEventListener("DOMContentLoaded", function () {
    ...
    function snapping(drag, first) {
        ...
        // drag.innerHTML += `<div class='blockyleft'><img src='./assets/eyeblue.svg'><p class='blockyname'>${node_cfg.title}</p></div><div class='blockyright'><img src='${node_cfg.img}'></div><div class='blockydiv'></div><div class='blockyinfo'>${node_cfg.desc}</div>`;
        return true;
    }
